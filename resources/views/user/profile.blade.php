...
@section('content')
    ...
    <form class="form-horizontal" method="POST" action="{{ route('user.profile.update') }}">
        ...
        <div class="form-group">
            <label for="email" class="col-md-4 control-label">Email ({{ $user->getEmailVerifiedAt() ? "Email Verified" : "Email Not Verified" }})</label>
            @if ($user->getEmailVerifiedAt() == null)
                <a href="{{ route('user.verification.send') }}" class="btn btn-primary">Send Email Verification</a>
            @endif
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input id="status_perkawinan" type="text" class="form-control" name="status_perkawinan"
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input id="id_rukun_tetangga" type="text" class="form-control" name="id_rukun_tetangga"
                    value="{{ old('id_rukun_tetangga', $user->getRukunTetangga()->getNomorRukunTetangga()) }}" disabled>
            </div>
        </div>
