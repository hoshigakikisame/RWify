...
<div class="card-container px-3 py-4">
    <div class="card-wrap overflow-hidden rounded-xl border dark:border-gray-700">
        <div class="card-img h-[275px] w-full bg-cover bg-center" style="background-image: url({{ $image }})">
        ...
        <div class="card-body mx-6 my-5 flex flex-col gap-2">
            ...
            <p class="dark:text-gray-500">
                Dikarenakan cuaca di Malang yang akhir-akhir ini tidak menentu, secara terpaksa senam rutin bulanan yang
                awalnya akan dilaksanakan pada
            </p>
