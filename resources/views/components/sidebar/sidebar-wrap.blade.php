...
<aside class="relative z-20 min-h-screen">
            ...
            <div class="user-wrap mb-2 w-fit rounded-full border p-2 text-gray-800">
                <div class="user flex items-center lg:gap-2">
                    <button id="moreButton">
                        <div
                            class="h-11 w-11 rounded-full bg-white bg-cover bg-center dark:bg-gray-900"
                        ...
                        >
                            <div class="flex w-full flex-col px-1 py-2">
                                @foreach ($footerMenu as $key => $item)
                                    <a
                                        class="inline-flex items-center gap-2 text-nowrap rounded-md px-3 py-1 text-gray-800 hover:bg-white dark:text-gray-200 dark:hover:bg-gray-800"
                                        href="{{ $item['link'] }}"
                                    >
                                        <span class="fill-gray-800 dark:fill-gray-200">{!! $item['icon'] !!}</span>
                                        {{ $key }}
                                    </a>
                                @endforeach
                            </div>
