...
<div class="card-container px-3 ">
    <div class="card-wrap rounded-xl overflow-hidden  border">
        <div class="card-img bg-cover bg-center w-full h-[275px]" style="background-image: url({{$image}});">
            <div class="w-full h-full backdrop-brightness-75"></div>
        </div>
        <div class="card-body mx-6 my-5 flex flex-col gap-2">
            <h5 class="text-xs">2 hari yang lalu</h5>
            <h2 class="text-lg font-medium leading-6">Senam Rutin Bulanan Diundur Karena Cuaca Buruk</h2>
            <p>Dikarenakan cuaca di Malang yang akhir-akhir ini tidak menentu, secara terpaksa senam rutin bulanan yang awalnya akan dilaksanakan pada</p>
            <div class="action-button">
                <button class="flex items-center justify-center">
                    <span class="py-2 text-xs">Selengkapnya</span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5 pt-1">
