                            ...
                            <div
                                ...
                                <div x-show="modalOpen" x-transition:enter="transition ease-out duration-300 transform"
                                    ...
                                    <form enctype="multipart/form-data" class="mt-5" id="addModalForm"
                                        ...
                                        <x-inputform title="Nama Pemilik" key="nama_pemilik" type="text"
                                            placeholder="Pemilik" />
                                        <x-inputform title="No. Telepon" key="telepon" type="text"
                                            placeholder="1234567892322" />
                                        <x-textareainputform title="Alamat" key="alamat"
                                            placeholder="Jl Brawijaya no 14" />
                                        <x-inputform title="Maps URL" key="map_url" type="text" placeholder="Maps" />
                                        <x-inputform title="Instagram URL" key="instagram_url" type="text"
