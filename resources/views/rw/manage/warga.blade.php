...
<section class="container px-2 mx-auto relative">
    <div class="sm:flex sm:items-center justify-normal sm:justify-between">
        ...
        <div class="flex gap-2 sm:flex-row items-start sm:items-center mt-4 sm:gap-x-3 ">
            ...
            <button id="addButton" class="flex items-center justify-center md:w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>

                <span class="text-nowrap">Add warga</span>
            </button>
        </div>
    </div>
    ...
    <div class="mt-6 md:flex md:items-center md:justify-between">
        ...
        <div class="relative flex items-center w-fit mt-4 md:mt-0">
            <span class="absolute">
                    ...
                    <table class="min-w-full w-full table-auto divide-y divide-gray-200 dark:divide-gray-700 px-2">
                        <thead class="bg-gray-50 dark:bg-gray-800">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Tempat Tanggal Lahir</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                            ...
                            <tr>
                                <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                    <div>
                                        <h2 class="font-medium text-gray-800 dark:text-white ">{{ $user->getNIK() }}</h2>
                                    </div>
                                </td>
                                <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                ...
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <div>
                                        <h4 class="text-gray-700 dark:text-gray-200">{{ $user->getNamaDepan() . " " . $user->getNamaBelakang() }}</h4>
                                    </div>
                                </td>
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <p class=" -mx-1 text-xs text-blue-600 ">{{ $user->getTempatLahir() . ", " . $user->getTanggalLahir() }}</p>
                                </td>
            ...
            <form action="" class="w-full ">
                <section class="data-diri flex gap-2 mb-2 border-solid border-b py-3 justify-between ">
                    ...
                    <div class="form-fields grow">
                        ...
                        <div class="jenis-kelamin-dan-golongan-darah flex gap-4">
                            ...
                            $golonganDarah =["O-"=>"O-","O+"=>"O+","A-"=>"A-","A+"=>"A+","B-"=>"B-","B+"=>"B+","AB-"=>"AB-","AB+"=>"AB+"];
                            @endphp
                            <x-selectinputform title="Jenis Kelamin" key="jenis_kelamin" :options="$genderOptions" />
                            <x-selectinputform title="Golongan Darah" key="golongan_darah" :options="$golonganDarah" />
                        </div>
                    </div>
                </section>
                <section class="status flex gap-2 border-solid border-b py-3 justify-between ">
                    ...
                    <div class="form-fields grow">
                        ...
                        $role =["Ketua RW"=>"rw"]
                        @endphp
                        <x-selectinputform title="Agama" key="agama" :options="$agama" />
                        <x-selectinputform title="Status Perkawinan" key="status_perkawinan" :options="$statusPerkawinan" />
                        <x-inputform title="Pekerjaan" key="pekerjaan" type="text" />
                        <x-selectinputform title="Peran" key="role" :options="$role" />
                    </div>
                </section>
