...
@section('content')
    ...
    <div class="dark:text-gray-200 dark:fill-gray-200">
        <section class="mb-10">
            ...
            <swiper-container id="swiper-container-hero" class="mySwiper w-full h-[500px] lg:h-[650px]"
                pagination-clickable="true" slides-per-view="1" speed="500" loop="true" pagination="true" init="false">
                <swiper-slide class=" bg-cover bg-left" style="background-image: url('{{ $image }}');">
                    <div
                        class="text-container backdrop-brightness-50 dark:backdrop-brightness-75 flex flex-col justify-center items-center h-full w-full">
            ...
            <div class="body-section ">
                <swiper-container slides-per-view="3" scrollbar-hide="false" draggable="true">
                    @foreach ($ucapan as $item)
                        <swiper-slide>
                            <x-carditemmessage :name="$item['name']" :position="$item['position']" :desc="$item['desc']" :date="$item['date']"
                                :image="$item['image']" />
                        </swiper-slide>
                    @endforeach
                </swiper-container>
        ...
        <footer class="bg-darkGreen relative">
            ...
            @endphp
            <footer class="footer-devided relative">
