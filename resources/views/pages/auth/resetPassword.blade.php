...
<div class="overflow-hidden h-screen relative">
    <div class="grid grid-rows-4 md:grid-rows-3 lg:grid-rows-1 lg:grid-cols-2 h-full bg-gray-50 dark:bg-gray-900">
        <div class="resetPassword-image lg:relative">
            ...
            <div id="resetPassword-image" class="absolute Sign-Image top-0 bottom-0 right-0 left-0 bg-cover hidden lg:block" style="background-image: url('{{$image}}')">
                        ...
                        <div class="resetPassword-body md:w-3/5 ">
                            <form class="form" method="POST" action="{{ route('password.update') }}">
                                ...
                                <div class="form-group mb-5">
                                    <label for="email" class="text-gray-600 dark:text-gray-300">E-Mail Address</label>

                                    <div class="col-md-6">
                                        <input id="email" type="email" class="flex h-12 w-full items-center justify-center rounded-md border p-3 text-sm outline-none border-gray-200 dark:bg-gray-900 dark:text-gray-100" name="email" value="{{ old('email') }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-5">
                                    ...
                                    <div class="col-md-6">
                                        <input id="password" type="password" class="flex h-12 w-full items-center justify-center rounded-md border p-3 text-sm outline-none border-gray-200 dark:bg-gray-900 dark:text-gray-100" name="password" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-3 md:mb-4 lg:mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="password_confirmation" type="password" class="flex h-12 w-full items-center justify-center rounded-md border p-3 text-sm outline-none border-gray-200 dark:bg-gray-900 dark:text-gray-100" name="password_confirmation" required>
                                    </div>
                                </div>
