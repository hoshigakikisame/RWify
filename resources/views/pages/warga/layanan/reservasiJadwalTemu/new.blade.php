...
<section class="mt-7 ms-10 mb-20">
    <div class="header mb-5 border-b pb-5 ">
        <h1 class="dark:text-gray-100 font-medium text-lg text-gray-950">Reservasi</h1>
    ...
    <div class="form bg-gray-50 dark:bg-gray-800/50 px-8 py-4 pb-8 rounded-lg shadow-sm w-1/2">
        <form action="{{route('warga.layanan.reservasiJadwalTemu.new')}}" method="POST" enctype="">
            ...
            <div class="form-header mt-2 mb-6">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Buat reservasi dengan lengkap dengan deskripsi yang jelas</p>
            </div>
            <div class="form-body">
