                        ...
                        <div class="col-span-2 row-span-1 mt-4">
                            <div class="container">
                                ...
                                <div class="mt-4">
                                    <div class="border-b-2">
                                        @foreach ($ownedPropertiInstances as $properti)
                                            <div class="grid grid-cols-3 grid-rows-2 mt-2">
                                                <div class="col-span-2 row-span-2">
                                                    <p class="mb-2 text-md"> {{ $properti->getNamaProperti() }}</p>
                                                    <p class="mb-2 text-sm text-gray-500">
                                                        {{ $properti->getTipeProperti()->getNamaTipe() }}
                                                    </p>
                                                </div>
                                                <div
                                                    class="col-span-1 row-span-2 text-right items-center justify-end inline-flex">
                                                    <p class="mb-2 text-xl font-semi-bold align-middle">
                                ...
                                <div class="grid grid-cols-3 grid-rows-1 mt-2">
                                    ...
                                    <div class="col-span-1 row-span-1 text-right items-center justify-end inline-flex">
                                        <p class="mb-2 text-xl font-semi-bold align-middle">
                            ...
                            <div class="container mt-10">
                                ...
                                <div class="mt-4">
                                    <div class="container">
                                        <div class="grid grid-cols-3 grid-rows-2 mt-2">
                                            <div class="col-span-2 row-span-2">
                                                <p class="mb-2 text-lg font-semi-bold text-gray-500">
                        ...
                        <div class="col-span-3 mt-4" x-ref="wrap" x-data="{ fileName: '' }">
                            ...
                            <div class="mt-4">
                                ...
                                <label for="dropzone-file"
                                    class="mt-4 text-sm text-gray-700 capitalize dark:text-gray-300">Bukti
                                    Pembayaran</label>
                                <div
                                    class="h-[300px] flex mt-2 flex-col items-center justify-center w-full h-full border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600 relative">
                                    <div x-ref="dnd" class="w-full h-full flex flex-col">
                                        ...
                                        <div class="w-full h-[360px] bg-cover bg-center hidden" x-ref="imgPreviewWrapper">
                                        </div>
