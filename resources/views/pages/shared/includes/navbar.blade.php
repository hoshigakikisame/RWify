        ...
        <div class="nav-container w-full py-5">
            <nav class="flex items-center justify-between md:gap-10">
                        ...
                        <li class="link-item relative" x-data="{ dropdownIsOpen: false }">
                            ...
                            >
                                ...
                                @foreach ($layanan as $item)
                                    <x-dropdown.dropdown-element-navbar
                                        :title="$item['title']"
                                        :href="$item['href']"
                                        :desc="$item['desc']"
                                        :icon="$item['icon']"
                ...
                <div class="navbar-action ms-2 flex items-center gap-3">
                    ...
                    <a
                        class="login-button order-2 h-fit rounded-lg border border-gray-200 border-opacity-10 bg-green-900 px-2 py-1 text-gray-100 dark:bg-green-700 dark:text-gray-200 md:order-1 md:px-4"
