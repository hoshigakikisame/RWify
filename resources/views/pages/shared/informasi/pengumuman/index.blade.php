            ...
            <section class="pt-18 mb-36 px-8 lg:px-24">
                <div class="mb-5 pt-12">
                    ...
                    <p class="font-Inter text-sm md:text-lg">
                        Berita dan informasi adalah sarana utama bagi warga untuk terhubung secara langsung dan mudah dengan
                        perkembangan terkini di wilayah RW ini.
                        Dengan adanya berita dan informasi sebagai sarana utama, warga dapat secara aktif mengikuti
                        perkembangan
                        penting di sekitar mereka,
                ...
                <div class="pengumuman mt-20 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    @if (count($pengumumanInstances) == 0)
                        <div class="h-80 "></div>
                    @endif
                    @foreach ($pengumumanInstances as $pengumuman)
                        <div class="w-full">
                            <div class="card w-full overflow-hidden rounded-lg shadow-lg dark:bg-SecondaryBg hover:shadow:900"
                                id="pengumuman-{{ $pengumuman->getIdPengumuman() }}">
                                <div class="h-64 w-full">
                                    <img src="{{ $pengumuman->getImageUrl() }}" alt="Gambar Pengumuman"
                                ...
                                <div class="card-content px-10 py-5">
                                    <div class="card-header h-16">
                                        ...
                                        <h5 class="text-lg font-semibold pt-2  line-clamp-2">{{ $pengumuman->getJudul() }}
                                        </h5>
                                    </div>
                                    ...
                                    <a href="{{ route('informasi.pengumuman.detail', [$pengumuman->getIdPengumuman()]) }}"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                            class="h-5 w-5 pt-1 text-green-700" fill="green">
                                            <path
