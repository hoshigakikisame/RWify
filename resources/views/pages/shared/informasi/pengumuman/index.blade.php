            ...
            <div class="w-full">
                <div class="card w-full overflow-hidden rounded-lg shadow-lg dark:bg-gray-800 hover:shadow:900" id="pengumuman-{{ $pengumuman->getIdPengumuman() }}">
                    ...
                    <div class="card-content px-10 py-5">
                        ...
                        <div class="underline text-sm font-poppins text-green-700 dark:text-green-500">
                            <a target="_blank" href="{{ route('informasi.pengumuman.detail', [$pengumuman->getIdPengumuman()]) }}">Selengkapnya -></a>
                        </div>
                    </div>
                </div>
            </div>
