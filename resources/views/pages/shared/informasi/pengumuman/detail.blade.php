    ...
    <div class="overflow-hidden">
        ...
        <div class="h-screen overflow-scroll dark:fill-gray-200 dark:text-gray-200">
            <section class="mb-28 px-8 lg:px-16">
                <div class="header-section mx-auto mb-20 max-w-2xl text-center">
                ...
                <div class="mx-auto mb-20 max-w-6xl text-center">
                    <img
                        src="{{ $pengumumanInstance->getImageUrl() }}"
                        class="mx-auto max-h-96 w-full rounded-lg object-cover"
            ...
            <section class="mb-56 px-8 lg:px-16">
                <div class="header-section mx-auto mb-10 max-w-2xl text-center">
                ...
                <div class="flex justify-center space-x-4">
                    <a
                        ...
                        target="_blank"
                        class="flex items-center rounded-lg bg-gray-500 px-4 py-2 text-white"
                    >
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" class="mr-2 h-5 w-5" viewBox="0 0 24 24">
                            <path
                                fill="currentColor"
                                d="M22.675 0H1.325C.593 0 0 .593 0 1.326v21.348C0 23.407.593 24 1.325 24h11.495v-9.294H9.692v-3.622h3.128V8.413c0-3.1 1.894-4.788 4.66-4.788 1.325 0 2.464.099 2.797.143v3.24l-1.92.001c-1.504 0-1.795.714-1.795 1.763v2.312h3.59l-.467 3.622h-3.123V24h6.116c.732 0 1.325-.593 1.325-1.326V1.326C24 .593 23.407 0 22.675 0z"
                            />
                        </svg>
                        Facebook
                    </a>
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" class="mr-2 h-5 w-5" viewBox="0 0 24 24">
                            <path
                                fill="currentColor"
                                d="M3.9 3.9h6.6V1.5H1.5v9H3.9zm16.2 16.2h-6.6v2.4h9v-9h-2.4zM3.9 3.9h6.6V1.5H1.5v9H3.9zm0 13.2h6.6v-2.4H3.9v6.6h6.6v-2.4H3.9zm13.2 0v6.6h2.4v-9h-2.4z"
                            />
                        </svg>
                        Salin Tautan
                    </button>
