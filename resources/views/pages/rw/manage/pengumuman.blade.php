                ...
                <div class="flex items-center gap-x-3">
                    ...
                    <span class="inline-flex items-center gap-2 rounded-full bg-green-100 px-3 py-1 dark:bg-gray-800">
                        ...
                        <span class="relative flex h-3 w-3 items-center justify-center">
                            <span
                                class="absolute inline-flex h-full w-full animate-ping rounded-full bg-green-400 opacity-75 duration-700"
                            ></span>
                                ...
                                >
                                    <div class="card-heading mb-1 flex items-start justify-between px-8">
                                        ...
                                        <div class="action-dropdown relative" x-data="{ actionModalOpen: false }">
                                            <button
                                                class="mt-1 h-5 w-5 dark:fill-gray-100"
                                            ...
                                            <div
                                                class="absolute right-8 top-0 divide-y overflow-hidden rounded-lg border bg-white dark:divide-gray-700 dark:border-gray-700"
                                                style="display: none"
                                            ...
                                            >
                                                ...
                                                <button
                                                    ...
                                                    @click="modalShareOpen = !modalShareOpen"
                                                    type="button"
                                                ...
                                                >
                                                    ...
                                                    <p
                                                        class="me-4 text-xs font-medium text-green-600 dark:text-green-400"
                                                    >
                                                        @if ($pengumuman->getStatus() == 'publish')
                                                            Draf
                                                        @else
                                                ...
                                                >
                                                    ...
                                                    <p
                                                        class="me-4 text-xs font-medium text-blue-600 dark:text-blue-400"
                                                    >
                                                        Edit
                                                    </p>
                                                </button>
                                                ...
                                                >
                                                    ...
                                                    <p
                                                        class="dark:text-rosse-400 me-4 text-xs font-medium text-rose-500"
                                                    >
                                                        Delete
                                                    </p>
                                                </button>
