                            ...
                            <div class="card-heading mb-1 px-8 flex justify-between items-start">
                                ...
                                <div class="action-dropdown relative" x-data="{ actionModalOpen: false }">
                                    ...
                                    <div class="absolute right-8 top-0 rounded-lg border dark:border-gray-700 overflow-hidden divide-y dark:divide-gray-700" style="display: none;" x-show="actionModalOpen" @click.away="actionModalOpen = false" x-data="{ modalEditOpen: false, modalDeleteOpen: false }">
                                        ...
                                        <button id="editButton" class="inline-flex gap-2 px-4 pt-2 pb-2  hover:bg-gray-100 dark:hover:bg-gray-800 w-full items-center" @click="modalEditOpen = !modalEditOpen" type="button" onclick="(function () {appendUpdateModal({{ $pengumuman }},event);window.utils.Request.actionRequest(`{{ route('rw.manage.pengumuman.update') }}`, '#editModal', '#editModalForm')})()" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-200 transform" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
