            ...
            <div class="sm:flex sm:items-center sm:justify-between ">
                <div>
                    <div class=" flex items-center gap-x-3">
                        ...
                        <span
                            class="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400">{{ $umkmInstances->total() }}
                            UMKM</span>
                    </div>
                            ...
                            <div
                                ...
                                <div x-show="modalOpen" x-transition:enter="transition ease-out duration-300 transform"
                                    ...
                                    <form enctype="multipart/form-data" class="mt-5" id="addModalForm"
                                        ...
                                        <x-form.inputform title="Nama UMKM" key="nama" type="text"
                                            placeholder="UMKM" />
                                        <x-form.inputform title="Nama Pemilik" key="nama_pemilik" type="text"
                                            placeholder="Pemilik" />
                                        <x-form.inputform title="No. Telepon" key="telepon" type="text"
                                            placeholder="1234567892322" />
                                        <x-form.textareainputform title="Alamat" key="alamat"
                                            placeholder="Jl Brawijaya no 14" />
                                        <x-form.inputform title="Maps URL" key="map_url" type="text"
                                            placeholder="Maps" />
                                        <x-form.inputform title="Instagram URL" key="instagram_url" type="text"
                                            placeholder="Instagram" />
                                        <x-form.textareainputform title="Deskripsi" key="deskripsi"
                                            placeholder="Deskripsi" />
                                        <x-form.inputimage id="imageadd" title="Gambar" key="image"
                                            placeholder="Gambar" />
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-4 text-sm">
                                            <button id="imageButtom"
                                                ...
                                                type="button"
                                                onclick="(function () {appendUpdateModal({{ $umkm }},event);request(`{{ route('rw.manage.umkm.update') }}`, '#editModal', '#editModalForm')})()">
                                                <span
                                        ...
                                        <td class="px-4 py-4 pe-4 pe-0 ps-6 text-sm flex" id="action"
                                            ...
                                            <a id="detailButton"
                                                class="relative align-middle select-none font-sans font-medium text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none w-10 max-w-[40px] h-10 max-h-[40px] rounded-lg text-xs text-blue-gray-500 hover:bg-blue-gray-500/10 active:bg-blue-gray-500/30" target="_blank" href="{{route('informasi.umkmPage', ['#umkm-' . $umkm->getIdUmkm() ])}}">
                                                <span
                                                    class="absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2">
