...
<body class="relative bg-white dark:bg-gray-900">
    <main class="flex">
        ...
        @endphp
        <x-sidebarwrap email="{{auth()->user()->email}}" role="{{auth()->user()->role}}" :imageProfile="auth()->user()->getImageUrl()" :footerMenu="$footerMenu">
            ...
            <x-sidebaritem href="{{route('rw.manage.warga.warga')}}" title="Pendataan" :active="request()->routeIs(['rw.manage.warga.warga'])">
            ...
            <x-sidebaritem href="{{route('rw.dashboard')}}" title="Iuran Warga">
            ...
            <x-sidebaritem href="{{route('rw.manage.pengaduan.pengaduan')}}" title="Pengaduan" :active="request()->routeIs(['rw.manage.pengaduan.pengaduan'])">
                <svg xmlns=" http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 24 24" class="lg:w-5 w-6">
            ...
            <x-sidebaritem href="{{route('rw.manage.pengumuman.pengumuman')}}" title="Pengumuman" :active="request()->routeIs(['rw.manage.pengumuman.pengumuman'])">
                <svg xmlns=" http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 24 24" class="lg:w-5 w-6">
