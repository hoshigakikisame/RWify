...
@section('menu')
    @php
        $activeStyle = [
            ...
            'active' => 'sidebar-item flex w-full items-center justify-center gap-3 text-nowrap rounded-lg rounded-lg bg-gray-100 fill-blue-600 px-3 py-2 text-blue-600 dark:bg-gray-800 dark:fill-blue-400 dark:text-blue-300 dark:hover:bg-gray-800 lg:justify-normal',
        ];

        $activeDropIuran = request()->routeIs(['rw.manage.iuran.leaderboard', 'rw.manage.iuran.index', 'rw.manage.iuran.verify']);

        $activeDropPendataan = request()->routeIs(['rw.manage.pendataan.kartuKeluarga.kartuKeluarga', 'rw.manage.pendataan.warga.warga']);
    ...
    <li class="relative" x-data="{ sideDropdown: false }">
        <button
            class="{{ $activeDropPendataan ? $activeStyle['active'] : $activeStyle['default'] }}"
        ...
        <ul x-show="sideDropdown" class="ms-3 mt-2 flex flex-col gap-2">
            <x-sidebar.sidebar-item
                href="{{ route('rw.manage.pendataan.kartuKeluarga.kartuKeluarga') }}"
            ...
            <x-sidebar.sidebar-item
                href="{{ route('rw.manage.pendataan.warga.warga') }}"
                title="Warga"
                :active="request()->routeIs(['rw.manage.pendataan.warga.warga'])"
            >
                <svg xmlns="http://www.w3.org/2000/svg" class="ionicon w-5 fill-inherit" viewBox="0 0 512 512">
    ...
    <li class="relative" x-data="{ sideDropdown: false }">
        ...
        <ul x-show="sideDropdown" class="ms-3 mt-2 flex flex-col gap-2">
            ...
            <x-sidebar.sidebar-item
                href="{{ route('informasi.iuranLeaderboard') }}"
                title="Leaderboard"
                :active="request()->routeIs(['informasi.iuranLeaderboard'])"
            >
    ...
    <li class="relative" x-data="{ sideDropdown: false }">
        <button
            class="{{ $activeDropBansos ? $activeStyle['active'] : $activeStyle['default'] }}"
            @click="sideDropdown = !sideDropdown"
            x-ref="dropdown"
            @mouseover="$($refs.dropdown).find('svg').addClass('!w-7')"
            @mouseleave="$($refs.dropdown).find('svg').removeClass('!w-7')"
        ...
        <ul x-show="sideDropdown" class="ms-3 mt-2 flex flex-col gap-2">
            <x-sidebar.sidebar-item
                href="{{ route('rw.manage.bansos.mfep') }}"
                title="MFEP"
                :active="request()->routeIs(['rw.manage.bansos.mfep'])"
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    version="1.1"
            ...
            <x-sidebar.sidebar-item
                href="{{ route('rw.manage.bansos.saw') }}"
                title="SAW"
                :active="request()->routeIs(['rw.manage.bansos.saw'])"
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    version="1.1"
