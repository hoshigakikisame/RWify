...
<li class="relative" x-data="{sideDropdown: false}">
    ...
    <ul x-show="sideDropdown" class="ms-3 mt-2 flex flex-col gap-2">
        <x-sidebar.sidebaritem href="{{ route('rw.dashboard') }}" title="Iuran" :active="request()->routeIs(['rw.dashboard'])">
        ...
        <x-sidebar.sidebaritem href="{{ route('rw.dashboard') }}" title="Kelola" :active="request()->routeIs(['rw.dashboard'])">
        ...
        <x-sidebar.sidebaritem href="{{ route('warga.layanan.pengaduan.newPengaduanPage') }}" title="Leaderboard" :active="request()->routeIs(['rw.dashboard'])">
...
<x-sidebar.sidebaritem href="{{ route('rw.manage.reservasiJadwalTemu.index') }}" title="Jadwal Temu" :active="request()->routeIs(['rw.manage.reservasiJadwalTemu.index'])">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="lg:w-5 w-6">
...
<li class="relative" x-data="{sideDropdown: false}">
    ...
    <ul x-show="sideDropdown" class="ms-3 mt-2 flex flex-col gap-2">
        ...
        <x-sidebar.sidebaritem href="{{ route('rw.manage.tipeProperti.index') }}" title="Tipe Properti" :active="request()->routeIs(['rw.manage.tipeProperti.index'])">
        ...
        <x-sidebar.sidebaritem href="{{ route('rw.manage.properti.index') }}" title="Properti Warga" :active="request()->routeIs(['rw.manage.properti.index'])">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="lg:w-5 w-6 fill-inherit" xml:space="preserve">
