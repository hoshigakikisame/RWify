...
<x-sidebar.sidebar-item href="{{ route('rw.manage.warga.warga') }}" title="Pendataan" :active="request()->routeIs(['rw.manage.warga.warga'])">
...
<li class="relative" x-data="{sideDropdown: false}">
    ...
    <ul x-show="sideDropdown" class="ms-3 mt-2 flex flex-col gap-2">
        <x-sidebar.sidebar-item href="{{ route('rw.dashboard') }}" title="Iuran" :active="request()->routeIs(['rw.dashboard'])">
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve" class="lg:w-5 w-6 fill-inherit">
                <g>
                    <path d="M411 8.783V100h91.211z" opacity="1" data-original="#000000" class=""></path>
                    <path d="M396 130c-8.284 0-15-6.716-15-15V0H166c-24.813 0-45 20.187-45 45v167.689c4.942-.448 9.943-.689 15-.689 51.128 0 96.897 23.376 127.186 60H426c8.284 0 15 6.716 15 15s-6.716 15-15 15H282.948a163.749 163.749 0 0 1 17.363 60H426c8.284 0 15 6.716 15 15s-6.716 15-15 15H300.311c-4.486 49.539-30.954 92.826-69.553 120H466c24.813 0 45-20.187 45-45V130zm30 82H206c-8.284 0-15-6.716-15-15s6.716-15 15-15h220c8.284 0 15 6.716 15 15s-6.716 15-15 15z" opacity="1" data-original="#000000" class=""></path>
                    <path d="M136 242C61.561 242 1 302.561 1 377s60.561 135 135 135 135-60.561 135-135-60.561-135-135-135zm-8.333 120h16.667c17.46 0 31.666 14.206 31.666 31.667v16.666c0 15.174-10.73 27.884-25 30.955V447c0 8.284-6.716 15-15 15s-15-6.716-15-15v-5.712c-14.27-3.071-25-15.781-25-30.955 0-8.284 6.716-15 15-15s15 6.716 15 15a1.67 1.67 0 0 0 1.667 1.667h16.667a1.67 1.67 0 0 0 1.667-1.667v-16.666a1.67 1.67 0 0 0-1.667-1.667h-16.667C110.206 392 96 377.794 96 360.333v-16.666c0-15.174 10.73-27.884 25-30.955V307c0-8.284 6.716-15 15-15s15 6.716 15 15v5.712c14.27 3.071 25 15.781 25 30.955 0 8.284-6.716 15-15 15s-15-6.716-15-15a1.67 1.67 0 0 0-1.667-1.667h-16.667a1.67 1.67 0 0 0-1.667 1.667v16.666a1.67 1.67 0 0 0 1.668 1.667z" opacity="1" data-original="#000000" class=""></path>
                </g>
            </svg>
        </x-sidebar.sidebar-item>
        <x-sidebar.sidebar-item href="{{ route('rw.dashboard') }}" title="Kelola" :active="request()->routeIs(['rw.dashboard'])">
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" x="0" y="0" viewBox="0 0 32 32" style="enable-background:new 0 0 512 512" xml:space="preserve" class="lg:w-6 w-7 fill-inherit">
                <g>
                    <path d="M2 8.7h28v4.08H2zM30 7.2c0-1.94-1.57-3.5-3.5-3.5h-21C3.57 3.7 2 5.26 2 7.2zM2 14.28v6.38c0 1.94 1.57 3.5 3.5 3.5h13.35a6.309 6.309 0 0 1 1.816-5.193c1.198-1.198 2.792-1.858 4.487-1.858s3.289.66 4.487 1.859c.127.127.244.261.358.397V14.28zm4.308 1.287h2.757a.9.9 0 0 1 0 1.8H6.308a.9.9 0 0 1 0-1.8zm5.514 5.188H6.308a.9.9 0 0 1 0-1.8h5.514a.9.9 0 0 1 0 1.8z" opacity="1" data-original="#000000" class=""></path>
                    <path d="M28.58 20.03a4.847 4.847 0 0 0-6.85 0 4.829 4.829 0 0 0 0 6.85c1.89 1.89 4.96 1.89 6.85 0s1.89-4.96 0-6.85zm-1.315 3.38-2.22 1.789a.9.9 0 0 1-1.272-.145l-.873-1.113a.901.901 0 0 1 1.416-1.112l.311.396 1.51-1.217a.902.902 0 0 1 1.266.136.903.903 0 0 1-.138 1.266z" opacity="1" data-original="#000000" class=""></path>
                </g>
            </svg>
        </x-sidebar.sidebar-item>
        <x-sidebar.sidebar-item href="{{ route('warga.layanan.pengaduan.newPengaduanPage') }}" title="Leaderboard" :active="request()->routeIs(['rw.dashboard'])">
            <svg viewBox="0 0 24 24" class="lg:w-6 w-7 fill-inherit" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" class="fill-inherit" d="M13.436 5.783a3 3 0 0 0-2.872 0L5.769 8.397a3 3 0 0 0-1.563 2.634v4.938a3 3 0 0 0 1.563 2.634l4.795 2.614a3 3 0 0 0 2.872 0l4.794-2.614a3 3 0 0 0 1.564-2.634V11.03a3 3 0 0 0-1.564-2.634zM12 10.5c-.284 0-.474.34-.854 1.023l-.098.176c-.108.194-.162.29-.246.354-.085.064-.19.088-.4.135l-.19.044c-.738.167-1.107.25-1.195.532s.164.577.667 1.165l.13.152c.143.167.215.25.247.354s.021.215 0 .438l-.02.203c-.076.785-.114 1.178.115 1.352.23.174.576.015 1.267-.303l.178-.082c.197-.09.295-.135.399-.135s.202.045.399.135l.178.082c.691.319 1.037.477 1.267.303s.191-.567.115-1.352l-.02-.203c-.021-.223-.032-.334 0-.438s.104-.187.247-.354l.13-.152c.503-.588.755-.882.667-1.165-.088-.282-.457-.365-1.195-.532l-.19-.044c-.21-.047-.315-.07-.4-.135-.084-.064-.138-.16-.246-.354l-.098-.176c-.38-.682-.57-1.023-.854-1.023" clip-rule="evenodd" />
                <path class="fill-inherit" d="M11 2h2c1.886 0 2.828 0 3.414.586S17 4.114 17 6v.018l-2.846-1.552a4.5 4.5 0 0 0-4.308 0L7 6.018V6c0-1.886 0-2.828.586-3.414S9.114 2 11 2" />
            </svg>
        </x-sidebar.sidebar-item>
    </ul>
</li>
...
<x-sidebar.sidebar-item href="{{ route('rw.manage.umkm.umkm') }}" title="UMKM" :active="request()->routeIs(['rw.manage.umkm.umkm'])">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="lg:w-5 w-6">
        <path d="M16 13a5 5 0 0 1-8 0 4.956 4.956 0 0 1-7 .977V19a5.006 5.006 0 0 0 5 5h12a5.006 5.006 0 0 0 5-5v-5.026A4.956 4.956 0 0 1 16 13" />
...
<x-sidebar.sidebar-item href="{{ route('rw.manage.reservasiJadwalTemu.index') }}" title="Jadwal Temu" :active="request()->routeIs(['rw.manage.reservasiJadwalTemu.index'])">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="lg:w-5 w-6">
...
<li class="relative" x-data="{sideDropdown: false}">
    <button class="{{$activeDropProperti ? $activeStyle['active']:$activeStyle['default'];}}" @click="sideDropdown = !sideDropdown" x-effect="let path = document.location.pathname.split('/'); path.includes('properti') || path.includes('tipeProperti')  ? sideDropdown = true : sideDropdown = false">
        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" style="enable-background:new 0 0 512 512" xml:space="preserve" class="w-7 fill-inherit">
            <g>
                <path d="M2.001 6.609c0-1.013.43-1.985 1.179-2.667a3.575 3.575 0 0 1 2.779-.919c1.82.174 3.245 1.836 3.245 3.782v14.397a5.572 5.572 0 0 0-3.623-1.333c-.42 0-.844.047-1.268.144A5.403 5.403 0 0 0 2 21.179V6.609z" opacity="1" data-original="#000000"></path>
                <path d="M28.704 7.344H11.129v15.883c0 .568-.387 1.056-.942 1.188a1.204 1.204 0 0 1-1.36-.631c-.759-1.518-2.396-2.278-4.085-1.894a3.567 3.567 0 0 0-2.741 3.43v.071L2 25.43c.006.804.273 1.564.785 2.206a3.587 3.587 0 0 0 2.818 1.358l23.102.001c.715 0 1.296-.58 1.296-1.295V8.64a1.298 1.298 0 0 0-1.297-1.296zM14.595 10.09h4.759a.962.962 0 0 1 0 1.924h-4.759a.962.962 0 0 1 0-1.924zm-.963 4.289c0-.531.431-.962.962-.962h1.941a.962.962 0 0 1 0 1.924h-1.941a.962.962 0 0 1-.962-.962zm12.025 9.4c0 .832-.675 1.507-1.507 1.507h-7.177a1.507 1.507 0 0 1-1.507-1.507v-4.383c0-.498.246-.964.658-1.245l3.588-2.446a1.506 1.506 0 0 1 1.697 0l3.588 2.446c.412.281.658.747.658 1.245v4.383z" opacity="1" data-original="#000000" class=""></path>
            </g>
        </svg>
        <span class="hidden lg:block absolute left-16 lg:static rounded-lg bg-gray-200 lg:bg-transparent lg:dark:bg-transparent dark:bg-gray-700 px-2 py-1 lg:p-0 transition-all ease-in w-full">
            <div class="title flex gap-4 justify-between items-center">
