...
@section('menu')
    @php
        ...
        $activeDropPengaduan = request()->routeIs(['rt.layanan.pengaduan.index', 'rt.layanan.pengaduan.newPengaduanPage']);
    @endphp
    ...
    <div class="relative" x-data="{ sideDropdown: false }">
        ...
        <ul x-show="sideDropdown" class="ms-3 mt-2 flex flex-col gap-2">
            <x-sidebar.sidebar-item
                href="{{ route('rt.layanan.pembayaranIuran.riwayatPembayaranIuran') }}"
                title="Riwayat"
    ...
    <div class="relative" x-data="{ sideDropdown: false }">
        ...
        <ul x-show="sideDropdown" class="ms-3 mt-2 flex flex-col gap-2">
            <x-sidebar.sidebar-item
                href="{{ route('rt.layanan.pengaduan.index') }}"
                title="Pengaduan"
                :active="request()->routeIs(['rt.layanan.pengaduan.index'])"
            >
            ...
            <x-sidebar.sidebar-item
                href="{{ route('rt.layanan.pengaduan.newPengaduanPage') }}"
