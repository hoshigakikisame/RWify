...
@section('menu')
    ...
    <x-sidebar.sidebar-item href="{{ route('rt.manage.warga') }}" title="Data Warga" :active="request()->routeIs(['rt.manage.warga'])">
        <svg xmlns=" http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 24 24" class="w-6 fill-inherit lg:w-5">
            <path
    ...
    <div class="relative" x-data="{ sideDropdown: false }">
        ...
        <ul x-show="sideDropdown" class="ms-3 mt-2 flex flex-col gap-2">
            <x-sidebar.sidebar-item href="{{ route('rt.layanan.pengaduan.index') }}" title="Pengaduan" :active="request()->routeIs(['rt.layanan.pengaduan.index'])">
            ...
            <x-sidebar.sidebar-item href="{{ route('rt.layanan.pengaduan.newPengaduanPage') }}" title="Buat Pengaduan"
                :active="request()->routeIs(['rt.layanan.pengaduan.newPengaduanPage'])">
    ...
    <x-sidebar.sidebar-item href="{{ route('rt.manage.reservasiJadwalTemu.index') }}" title="Jadwal Temu" :active="request()->routeIs(['rt.manage.reservasiJadwalTemu.index'])">
