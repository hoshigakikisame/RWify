...
<div class="relative" x-data="{sideDropdown: false}">
    <button class="{{$activeDropIuran ? $activeStyle['active']:$activeStyle['default'];}}" @click="sideDropdown = !sideDropdown" x-effect="document.location.pathname.split('/').includes('pembayaran-iuran') ? sideDropdown = true : sideDropdown = false">
    ...
    <ul x-show="sideDropdown" class="ms-3 mt-2 flex flex-col gap-2">
        <x-sidebar.sidebar-item href="{{ route('warga.layanan.pembayaran-iuran.index') }}" title="Iuran" :active="request()->routeIs(['warga.layanan.pembayaran-iuran.index'])">
        ...
        <x-sidebar.sidebar-item href="{{ route('warga.layanan.pembayaran-iuran.new') }}" title="Bayar Iuran" :active="request()->routeIs(['warga.layanan.pembayaran-iuran.new'])">
