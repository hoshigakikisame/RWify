...
@section('menu')
    ...
    @php
        ...
        $activeDropPengaduan = request()->routeIs([
            ...
            'warga.layanan.pengaduan.newPengaduanPage',
        ]);
        $activeDropReservasi = request()->routeIs([
            'warga.layanan.reservasiJadwalTemu.index',
            'warga.layanan.reservasiJadwalTemu.newReservasiJadwalTemuPage',
        ]);
    @endphp
    ...
    <div class="relative" x-data="{ sideDropdown: false }">
        ...
        <ul x-show="sideDropdown" class="ms-3 mt-2 flex flex-col gap-2">
            ...
            <x-sidebar.sidebar-item href="{{ route('warga.layanan.pembayaranIuran.riwayatPembayaranIuran') }}"
                title="Riwayat" :active="request()->routeIs(['warga.layanan.pembayaranIuran.riwayatPembayaranIuran'])">
            ...
            <x-sidebar.sidebar-item href="{{ route('warga.layanan.pembayaranIuran.newIuranPage') }}" title="Bayar Iuran"
    ...
    <div class="relative" x-data="{ sideDropdown: false }">
        ...
        <ul x-show="sideDropdown" class="ms-3 mt-2 flex flex-col gap-2">
            ...
            <x-sidebar.sidebar-item href="{{ route('warga.layanan.pengaduan.newPengaduanPage') }}" title="Buat Pengaduan"
    ...
    <div class="relative" x-data="{ sideDropdown: false }">
        <button class="{{ $activeDropReservasi ? $activeStyle['active'] : $activeStyle['default'] }}"
            @click="sideDropdown = !sideDropdown"
            x-effect="
        ...
        <ul x-show="sideDropdown" class="ms-3 mt-2 flex flex-col gap-2">
            <x-sidebar.sidebar-item href="{{ route('warga.layanan.reservasiJadwalTemu.index') }}" title="Reservasi"
            ...
            <x-sidebar.sidebar-item href="{{ route('warga.layanan.reservasiJadwalTemu.newReservasiJadwalTemuPage') }}"
                title="Buat Reservasi" :active="request()->routeIs(['warga.layanan.reservasiJadwalTemu.newReservasiJadwalTemuPage'])">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-6 fill-inherit lg:w-5">
                    <path
